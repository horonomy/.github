#!/usr/bin/env python3
"""Regenerate Horonomy company-metadata consumers from metadata/company.yaml.
...
def render_company_json(data: dict) -> str:
    ...
    projection = {
        "_readme": (
            ...
            "metadata/company.yaml (Horonomy company metadata registry, AAASM-5520)."
        ),
...
def render_security_block(data: dict) -> str:
    ...
    return "\n".join(
        [
            f"If you discover a security vulnerability in any Horonomy repository, "
